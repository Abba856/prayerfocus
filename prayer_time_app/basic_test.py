"""
Basic test suite for Prayer Time Reminder and Auto Computer Lock System
This test avoids pygame-dependent components for environments where pygame isn't available
"""
...
def run_basic_test():
    """Run a basic end-to-end test without pygame dependencies"""
    print("=" * 60)
    print("BASIC APPLICATION TEST (without pygame)")
    print("=" * 60)
    ...
    # Test 5: Emergency unlock
    print("\n5. Testing Emergency Unlock...")
